...
export const rgbFromHex = (color: string) => {
  ...
  if (color.length == 4) {
    rgb.r = Number.parseInt(color[1] + color[1], 16);
    rgb.g = Number.parseInt(color[2] + color[2], 16);
    rgb.b = Number.parseInt(color[3] + color[3], 16);
  } else if (color.length == 7) {
    rgb.r = Number.parseInt(color[1] + color[2], 16);
    rgb.g = Number.parseInt(color[3] + color[4], 16);
    rgb.b = Number.parseInt(color[5] + color[6], 16);
  }
