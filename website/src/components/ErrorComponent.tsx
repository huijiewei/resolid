...
export const ErrorComponent = () => {
  ...
  if (isRouteErrorResponse(error)) {
    return (
      <div className={"relative mx-auto mt-20 flex h-full max-w-3xl items-center justify-center p-4"}>
        ...
        <div className={"prose z-10 mt-28 max-w-xl text-center dark:prose-invert"}>
          <h1>页面未找到</h1>
          <p>
