...
export const ErrorComponent = () => {
  ...
  if (isRouteErrorResponse(error)) {
    return (
      <div className={"relative mx-auto flex max-w-2xl justify-center px-4 py-8"}>
        <svg
        ...
        <div className={"z-base prose mt-36 max-w-xl text-center dark:prose-invert md:mt-52"}>
          <h1>页面未找到</h1>
          <p>
