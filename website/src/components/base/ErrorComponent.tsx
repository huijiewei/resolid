...
export const ErrorComponent = () => {
  ...
  if (isRouteErrorResponse(error)) {
    return (
      <div className={"relative mx-auto mt-20 flex h-full max-w-2xl items-center justify-center p-4"}>
        <svg className={"absolute inset-0 fill-fg-normal/5"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 362 145">
        ...
        <div className={"z-base prose mt-28 max-w-xl text-center dark:prose-invert"}>
          <h1>页面未找到</h1>
          <p>
