...
<>
  ...
  <Drawer opened={opened} onClose={() => setOpened(false)}>
    ...
    <DrawerContent className={"w-11/12 md:w-3/5 lg:w-1/3"}>
      ...
      <DrawerBody className={"p-1 px-4"}>抽屉内容</DrawerBody>
      <DrawerFooter className={"flex items-center justify-center gap-5 p-4"}>
        <Button onClick={() => setOpened(false)}>关闭</Button>
      </DrawerFooter>
    </DrawerContent>
  </Drawer>
        ...
        <>
          ...
          <Drawer opened={opened} onClose={() => setOpened(false)}>
            ...
            <DrawerContent className={'w-11/12 md:w-3/5 lg:w-1/3'}>
              ...
              <DrawerBody className={'border-t border-b border-bd-subtle prose p-1 px-4 dark:prose-invert'}>
                <p>
  ...
  <>
    ...
    <Drawer opened={opened} onClose={() => setOpened(false)}>
      ...
      <DrawerContent className={"w-11/12 md:w-3/5 lg:w-1/3"}>
        ...
        <DrawerBody className={"p-1 px-4"}>内部大量内容</DrawerBody>
        <DrawerFooter className={"flex items-center justify-center gap-5 p-4"}>
          <Button onClick={() => setOpened(false)}>关闭</Button>
        </DrawerFooter>
      </DrawerContent>
  ...
  <>
    ...
    <Drawer initialFocus={initialRef} finalFocus={finalRef} opened={opened} onClose={() => setOpened(false)}>
      ...
      <DrawerContent className={"w-fit"}>
        ...
        <DrawerBody className={"flex flex-col gap-3 p-1 px-4"}>
          <div className={"flex flex-row items-center"}>
            <label htmlFor={"username"} className={"w-28"}>
              用户名 <span className={"text-red-500"}>*</span>
            </label>
...
<ComponentProps componentFile={"./drawer/drawer.tsx"} />
