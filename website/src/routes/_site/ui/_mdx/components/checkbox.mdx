...
<ComponentUsage preview={(props) => <Checkbox {...props}>复选框</Checkbox>} componentFile={"./checkbox/Checkbox.tsx"} ignoreProps={["icon","value","spacing"]} />
...
<ComponentProps componentFile={"./checkbox/CheckboxGroup.tsx"} />
