...
import { Checkbox, CheckboxGroup, Radio, RadioGroup } from '@resolid/react-ui';
...
<ComponentUsage preview={(props) => <Radio {...props}>单选框</Radio>} componentFile={"./radio/Radio.tsx"} ignoreProps={["icon","value","spacing"]} />
