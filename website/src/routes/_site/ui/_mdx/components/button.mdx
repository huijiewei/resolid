...
<ComponentUsage preview={(props) => <Button {...props}>按钮</Button>} component={"Button"} />
...
<ComponentProps title={"按钮"} component={"Button"} />

<ComponentProps title={"按钮组"} component={"ButtonGroup"} />
