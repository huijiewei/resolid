  ...
  <>
    ...
    <Modal opened={opened} onClose={() => setOpened(false)}>
      ...
      <ModalContent className={"w-11/12 md:w-3/5 lg:w-1/3"}>
        ...
        <ModalBody className={"p-1 px-4"}>模态框内容</ModalBody>
        <ModalFooter className={"flex items-center justify-center gap-5 p-4"}>
          <Button onClick={() => setOpened(false)}>关闭</Button>
        </ModalFooter>
      </ModalContent>
    </Modal>
...
<section className={'example group'}>
  <ComponentExample className={"flex flex-row gap-3"}>
    {() => {
      const [opened, setOpened] = useState(false);
      const [nestOpened, setNestOpened] = useState(false);
        ...
        <ModalBody className={"p-1 px-4"}>
          ...
          <Modal opened={nestOpened} onClose={() => setNestOpened(false)}>
            ...
            <ModalContent className={"w-60"}>
              ...
              <ModalBody className={"p-1 px-4"}>嵌套模态框内容</ModalBody>
              <ModalFooter className={"flex items-center justify-center gap-5 p-4"}>
                <Button onClick={() => setNestOpened(false)}>关闭</Button>
              </ModalFooter>
            </ModalContent>
        ...
        <>
          ...
          <Modal scrollBehavior={scrollBehavior} opened={opened} onClose={() => setOpened(false)}>
            ...
            <ModalContent className={'w-11/12 md:w-3/5 lg:w-1/3'}>
              ...
              <ModalBody className={'border-t border-b border-bd-subtle prose p-1 px-4 dark:prose-invert'}>
                <p>
                ...
                <p>
                  苹果的新款 M2 Pro 芯片提供最多 12 核 CPU 和最多 19 核 GPU，而 M2 Max 芯片提供 12 核 CPU 和最多 38 核
                  GPU。
                ...
                <p>
                  ...
                  看电影时续航时间长达 18 小时，浏览网页时续航时间长达 12 小时。 16 英寸 MacBook Pro 看电影时续航时间长达
                  22
                  小时，浏览网页时续航时间长达 15 小时。
                </p>
                <p>
                  其他功能包括 Wi-Fi 6E 和蓝牙 5.3 支持，Wi-Fi 6E 通过 6GHz 频段提供更快的无线连接和更低的延迟。 MacBook
                  Pro
        ...
        <>
          ...
          <Modal initialFocus={initialRef} finalFocus={finalRef} opened={opened} onClose={() => setOpened(false)}>
            ...
            <ModalContent className={'w-fit'}>
              ...
              <ModalBody className={'p-1 px-4 flex flex-col gap-3'}>
