    ...
    <AsideLayoutDispatchProvider value={setOpened}>
      <AsideLayoutStateProvider value={opened}>
        <div className={"mx-auto flex xl:max-w-6xl"}>
          <div
            className={
              "z-aside bg-bg-normal fixed flex h-9 w-full items-center justify-between border-b px-2 text-sm md:hidden"
            }
          >
          ...
          <aside
            className={clsx(
              "z-aside bg-bg-normal md:z-none fixed w-48 border-r md:block md:border-none",
